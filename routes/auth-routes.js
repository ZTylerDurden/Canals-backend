//POSTMAN CAN VALIDATE THIS ROUTE @ POST, body, x-www radio button http://localhost:3000/api/signup
// signUpUsername "pablo"
// signUpPassword "123"
// users collection should've been created
        ...
        theUser.save((err)=> {
            ...
            req.login(theUser,(err) => {
                ...
                // Clear the encryptedPassword before sending
                  ...
                  //postman will not return the password if you comment the below out
...
authRoutes.post('/api/login', (req, res, next) => {
    //The below is passing in from passport-config.js
...
authRoutes.post("/api/logout", (req, res, next) => {
  // req.logout() is defined by passport, POSTMAN LOGIN DETAILS TO LOGOUT
  req.logout();
